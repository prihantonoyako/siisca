...
class GroupMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        $groupMenuDB = MenuGroupModel::all();
        
        return view('menu.setting.menu-group', [
            'profile' => $profile,
            'rolesPengguna' => $rolesPengguna,
            'groupMenu' => $menus["GroupMenu"],
            'menu' => $menus["Menu"],
            'groupMenuDB' => $groupMenuDB
        ]);
    }
    ...
    public function create()
    {
        ...
        $urutanSuggestion = MenuGroupModel::pluck('urutan');
        return view('menu.setting.menu-group-create', [
            'profile' => $profile,
            'rolesPengguna' => $rolesPengguna,
            'groupMenu' => $menus["GroupMenu"],
            'menu' => $menus["Menu"],
    ...
    {
        $request->validate([
            'nama_group' => ['alpha', 'max:255'],
            'url_group' => ['alpha_dash', 'max:255'],
            'icon' => ['alpha_dash'],
            'urutan' => ['integer'],
        ]);
    ...
    public function update(Request $request, $id)
    {
        if ($request->ajax()) {
            ...
            $menuDB->is_aktif = $is_aktif;
            $menuDB->save();
            return response()->json(['success' => 'Menu is updated'],200);
        }
