...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (MenuModel::where('id_group', $request->input('id_group'))
            ...
            $urutanSuggestion = MenuModel::where('id_group', $request->input('id_group'))->pluck('urutan');
            return redirect()->back()->with('urutan_conflict', $urutanSuggestion)->withInput();
        }
