...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ asset('startbootstrap-coming-soon-gh-pages/assets/favicon.ico') }}"/>
        <!-- Font Awesome icons (free version)-->
        <!-- <script src="https://use.fontawesome.com/releases/v5.15.3/js/all.js" crossorigin="anonymous"></script>-->
        <!-- Use Font Awesome only local -->
        ...
        <link href="{{ asset('startbootstrap-coming-soon-gh-pages/css/styles.css') }}" rel="stylesheet" />
    </head>
    <body>
        <!-- Background Video-->
        ...
        <!-- Core theme JS-->
        <script src="{{ asset('startbootstrap-coming-soon-gh-pages/js/scripts.js') }}"></script>
    </body>
</html>
