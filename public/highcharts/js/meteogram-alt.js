...
Meteogram.prototype.tooltipFormatter = function (tooltip) {
    ...
    var index = tooltip.points[0].point.index,
        ret = '<small>' + Highcharts.dateFormat('%A, %b %e, %H:%M', tooltip.x) + '-' + Highcharts.dateFormat('%H:%M', tooltip.points[0].point.to) + '</small><br>';
    ...
    Highcharts.each(tooltip.points, function (point) {
        ...
        ret += '<tr><td><span style="color:' + series.color + '">\u25CF</span> ' + series.name +
            ': </td><td style="white-space:nowrap">' + Highcharts.pick(point.point.value, point.y) + series.options.tooltip.valueSuffix + '</td></tr>';
    });

    // Add wind
    ret += '<tr><td style="vertical-align: top">\u25CF Wind</td><td style="white-space:nowrap">' + this.windDirectionNames[index] +
        '<br>' + this.windSpeedNames[index] + ' (' + Highcharts.numberFormat(this.windSpeeds[index], 1) + ' m/s)</td></tr>';
        ...
        if (meteogram.resolution > 36e5 || i % 2 === 0) {
            ...
            if (sprite) {
                ...
                chart.renderer.image(
                    'http://www.highcharts.com/samples/graphics/meteogram-symbols-30px.png', -sprite.x, -sprite.y,
                90,
                570)
                    .add(group);
            }
    ...
    $.each(chart.series[0].data, function (i, point) {
        ...
        if (meteogram.resolution > 36e5 || i % 2 === 0) {
            ...
            if (meteogram.windSpeedNames[i] === 'Calm') {
                ...
                meteogram.windArrow(meteogram.windSpeedNames[i])).attr({
